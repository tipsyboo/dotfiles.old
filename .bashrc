...
alias mirror-update='sudo reflector --verbose --country Israel,Germany --age 12 --protocol http,https --sort rate --save /etc/pacman.d/mirrorlist'
alias c='clear'
alias calc='concalc'
alias se='sudo find / -name'
alias r=ranger
